...
class ImageCephDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        if '21k' in root:
            # Imagenet 22k
            annotation_root = 'classification/meta_data/'
        else:
            # Imagenet
            annotation_root = '/apdcephfs/share_1290939/0_public_datasets/imageNet_2012/meta/'
...
class ParserCephImage(Parser):
    ...
    def __init__(self,
        ...
        if '21k' in root:
            ...
            with open(osp.join(annotation_root, f'21k_to_label_{split}.txt'), 'r') as f:
