...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'GROOTV'
# Model name
_C.MODEL.NAME = 'GrootV'
...
# GROOTV parameters
_C.MODEL.GROOTV = CN()
_C.MODEL.GROOTV.DEPTHS = [4, 4, 18, 4]
_C.MODEL.GROOTV.GROUPS = [4, 8, 16, 32]
_C.MODEL.GROOTV.CHANNELS = 64
_C.MODEL.GROOTV.LAYER_SCALE = None
_C.MODEL.GROOTV.OFFSET_SCALE = 1.0
_C.MODEL.GROOTV.MLP_RATIO = 4.0
_C.MODEL.GROOTV.CORE_OP = 'DCNv3'
_C.MODEL.GROOTV.POST_NORM = False
_C.MODEL.GROOTV.RES_POST_NORM = False
_C.MODEL.GROOTV.DW_KERNEL_SIZE = None
_C.MODEL.GROOTV.USE_CLIP_PROJECTOR = False
_C.MODEL.GROOTV.LEVEL2_POST_NORM = False
_C.MODEL.GROOTV.LEVEL2_POST_NORM_BLOCK_IDS = None
_C.MODEL.GROOTV.CENTER_FEATURE_SCALE = False
_C.MODEL.GROOTV.REMOVE_CENTER = False
